...
/*
 * Une maille de la liste double chainée
 */
typedef struct Liste{
  void *el; /* élément courant */
 ...
 * (qui peut être trié via un callback)
 */
typedef struct SListe{
  /* callback comparant 2 éléments
   * 0 : même élément
   * 1 : el1 > el2
   * -1 : el1 < el2
   */
  int (*cmp)(void *el1, void *el2, void *param); 
  /* callback exportant l'élément */
